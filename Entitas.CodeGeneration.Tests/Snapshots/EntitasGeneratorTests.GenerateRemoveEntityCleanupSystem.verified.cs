...
public sealed class GameCleanupSystems : Feature
{
    ...
    {
        Add(new RemoveTestMemberGameSystem(contexts));
    }
}
...
// RemoveTestMemberGameSystem.g.cs
using System.Collections.Generic;
using Entitas;

public sealed class RemoveTestMemberGameSystem : ICleanupSystem
{
    readonly IGroup<GameEntity> _group;
    readonly List<GameEntity> _buffer = new List<GameEntity>();

    public RemoveTestMemberGameSystem(Contexts contexts)
    {
